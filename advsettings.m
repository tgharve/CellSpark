function varargout = advsettings(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @advsettings_OpeningFcn, ...
                   'gui_OutputFcn',  @advsettings_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before advsettings is made visible.
function advsettings_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = advsettings_OutputFcn(hObject, eventdata, handles) 
